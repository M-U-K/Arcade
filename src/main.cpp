...
{
      std::pair<std::pair<int, arcade::Window *>, std::pair<std::string, std::string>> (*func_print_name)(std::string, std::string, arcade::Window*, int);

     std::pair<std::pair<int, arcade::Window *>, std::pair<std::string, std::string>> test;
